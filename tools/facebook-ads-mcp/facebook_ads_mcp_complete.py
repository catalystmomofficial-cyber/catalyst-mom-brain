...
# crawl4ai is optional and only backs analyze_ad_creative_elements. Upstream
# imported the long-removed WebCrawler class at module scope, which crashed the
# server before any tool could register.
try:
...
class FacebookAdsLibraryAPI:
    ...
    def _analyze_ad_creative(self, snapshot_url: str) -> dict:
        ...
        if AsyncWebCrawler is None:
            return {
                "error": "crawl4ai is not installed, so creative scraping is unavailable. "
